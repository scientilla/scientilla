...
(function () {
        ...
        angular.module('trainingModules')
            .component('scientillaTrainingModuleVerificationForm', {
                templateUrl: 'partials/scientilla-training-module-verification-form.html',
                controller,
                controllerAs: 'vm',
                bindings: {
                    researchItem: "<",
        ...
        function controller(
            ...
            vm.verificationData = {};
            vm.trainingModule = vm.researchItem;
            ...
            vm.$onInit = function () {
                ...
                authors = ResearchItemService.getCompleteAuthors(vm.trainingModule);
                vm.authorsNames = authors.map(a => a.authorStr);

                user = context.getSubResearchEntity();
                vm.position = ResearchItemService.getUserIndex(vm.trainingModule, user);
            ...
            function copyToDraft() {
                ResearchEntitiesService.copyToDraft(vm.trainingModule);
            ...
            function viewCopyToDraft() {
                return vm.trainingModule.kind === 'v';
            }
