(function () {
    ...
    const documentFieldsRules = {
        authorsStr: {
            allowNull: false,
            regex: /^(([a-zA-ZÀ-ÖØ-öø-ÿ])([a-zA-ZÀ-ÖØ-öø-ÿ]|-|')*(\s([a-zA-ZÀ-ÖØ-öø-ÿ])([a-zA-ZÀ-ÖØ-öø-ÿ]|-|')*)*(\s[a-zA-ZÀ-ÖØ-öø-ÿ]\.)+)(,\s([a-zA-ZÀ-ÖØ-öø-ÿ])([a-zA-ZÀ-ÖØ-öø-ÿ]|-|')*(\s([a-zA-ZÀ-ÖØ-öø-ÿ])([a-zA-ZÀ-ÖØ-öø-ÿ]|-|')*)*(\s[a-zA-ZÀ-ÖØ-öø-ÿ]\.)+)*$/
        },
        scopusId: {
            allowNull: true,
            regex: /^\d*$/
