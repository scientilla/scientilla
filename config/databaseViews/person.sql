...
SELECT
  ...
  (
    CASE
      WHEN DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ) >= (DATE_PART('year', CURRENT_DATE) - 24) THEN '<25'
      WHEN DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ) >= (DATE_PART('year', CURRENT_DATE) - 29)
      AND DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ...
      WHEN DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ) >= (DATE_PART('year', CURRENT_DATE) - 34)
      AND DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ...
      WHEN DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ) >= (DATE_PART('year', CURRENT_DATE) - 44)
      AND DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ...
      WHEN DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ) >= (DATE_PART('year', CURRENT_DATE) - 54)
      AND DATE_PART(
        'year',
        (red.profile -> 'dateOfBirth' ->> 'value') :: date
      ...
      json_strip_nulls(
        json_build_object(
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'linkedin' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'linkedin' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'linkedin' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'linkedin' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'twitter' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'twitter' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'twitter' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'twitter' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'facebook' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'facebook' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'facebook' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'facebook' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'instagram' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'instagram' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'instagram' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'instagram' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'researchgate' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'researchgate' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'researchgate' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'researchgate' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'google_scholar' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'google_scholar' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'google_scholar' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'google_scholar' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (red.profile -> 'socials' -> 'github' ->> 'value') :: text
            WHERE
              (red.profile -> 'socials' -> 'github' ->> 'value') :: text IS NOT NULL
              AND (red.profile -> 'socials' -> 'github' ->> 'value') :: text != ''
              AND (
                (
                  red.profile -> 'socials' -> 'github' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'github' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'bitbucket' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'bitbucket' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'bitbucket' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'bitbucket' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (
                red.profile -> 'socials' -> 'youtube' ->> 'value'
              ) :: text
            WHERE
              (
                red.profile -> 'socials' -> 'youtube' ->> 'value'
              ...
              AND (
                (
                  red.profile -> 'socials' -> 'youtube' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'youtube' ->> 'privacy'
                ) :: text = 'hidden'
          ...
          (
            SELECT
              (red.profile -> 'socials' -> 'flickr' ->> 'value') :: text
            WHERE
              (red.profile -> 'socials' -> 'flickr' ->> 'value') :: text IS NOT NULL
              AND (red.profile -> 'socials' -> 'flickr' ->> 'value') :: text != ''
              AND (
                (
                  red.profile -> 'socials' -> 'flickr' ->> 'privacy'
                ) :: text = 'public'
                OR (
                  red.profile -> 'socials' -> 'flickr' ->> 'privacy'
                ) :: text = 'hidden'
  ...
  (
    SELECT
      (red.profile -> 'image' ->> 'value') :: text
    WHERE
      (red.profile -> 'image' ->> 'value') :: text IS NOT NULL
      AND (red.profile -> 'image' ->> 'value') :: text != ''
      AND (
        (red.profile -> 'image' ->> 'privacy') :: text = 'public'
        OR (red.profile -> 'image' ->> 'privacy') :: text = 'hidden'
      )
  ) AS image,
  (
    SELECT
      array_to_json(array_agg(titles ->> 'value'))
    FROM
      jsonb_array_elements(red.profile -> 'titles') titles
    WHERE
  ...
  (
    SELECT
      (red.profile -> 'description' ->> 'value') :: text
    WHERE
      (red.profile -> 'description' ->> 'value') :: text IS NOT NULL
  ...
  (
    SELECT
      (red.profile -> 'role' ->> 'value') :: text
    WHERE
      (red.profile -> 'role' ->> 'value') :: text IS NOT NULL
  ...
  (
    SELECT
      (red.profile -> 'website' ->> 'value') :: text
    WHERE
      (red.profile -> 'website' ->> 'value') :: text IS NOT NULL
  ...
  (
    SELECT
      (red.profile -> 'address' ->> 'value') :: text
    WHERE
      (red.profile -> 'address' ->> 'value') :: text IS NOT NULL
  ...
  (
    SELECT
      array_to_json(array_agg(interests ->> 'value'))
    FROM
      jsonb_array_elements(red.profile -> 'interests') interests
    WHERE
      interests ->> 'privacy' = 'public'
  ...
  (
    ...
    FROM
      jsonb_array_elements(red.profile -> 'experiencesExternal') experiences_external
    WHERE
      experiences_external ->> 'privacy' = 'public'
  ...
  (
    ...
    FROM
      jsonb_array_elements(red.profile -> 'education') education
    WHERE
      education ->> 'privacy' = 'public'
  ...
  (
    ...
    FROM
      jsonb_array_elements(red.profile -> 'certificates') certificates
    WHERE
      certificates ->> 'privacy' = 'public'
  ...
  (
          ...
          json_strip_nulls(
            json_build_object(
              ...
              (
                ...
                FROM
                  jsonb_array_elements(categories -> 'skills') skills
                WHERE
                  skills ->> 'privacy' = 'public'
    ...
    FROM
      jsonb_array_elements(red.profile -> 'skillCategories') categories
    WHERE
      categories ->> 'privacy' = 'public'
  ...
  (
          ...
          json_strip_nulls(
            json_build_object(
              ...
              (
                ...
                FROM
                  jsonb_array_elements(experiences_internal -> 'lines') lines
              )
            )
          )
        )
    ...
    FROM
      jsonb_array_elements(red.profile -> 'experiencesInternal') experiences_internal
    WHERE
      experiences_internal ->> 'privacy' = 'public'
