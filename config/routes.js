...
module.exports.routes = {
    ...
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/suggestedProjects']: 'ResearchEntity.getSuggestedProjects',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/suggestedPatents']: 'ResearchEntity.getSuggestedPatents',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/suggestedAccomplishments']: 'ResearchEntity.getSuggestedAccomplishments',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/suggestedTrainingModules']: 'ResearchEntity.getSuggestedTrainingModules',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/projects']: 'ResearchEntity.getVerifiedProjects',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/patents']: 'ResearchEntity.getVerifiedPatents',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/accomplishments']: 'ResearchEntity.getVerifiedAccomplishments',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/trainingModules']: 'ResearchEntity.getVerifiedTrainingModules',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/discardedProjects']: 'ResearchEntity.getDiscardedProjects',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/discardedPatents']: 'ResearchEntity.getDiscardedPatents',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/discardedAccomplishments']: 'ResearchEntity.getDiscardedAccomplishments',
    ['get ' + apiPrfx + '/researchentities/:researchEntityId/discardedTrainingModules']: 'ResearchEntity.getDiscardedTrainingModules',
